...
public class TokenServiceImpl implements TokenService {
    ...
    public String loginAndCreateToken(String email, String password) throws Exception {
        ...
        if (user != null) {
            ...
            redisOperation.set(ConstantValue.JWT_TOKEN_REDIS_KEY_PREFIX + user.getId(), token, ConstantValue.ACCESS_TOKEN_EXPIRE, TimeUnit.MILLISECONDS);
    ...
    public ResponseData resolveAndCheckToken(String token) throws Exception{
        try {
            ...
            return new ResponseData(StatusCode.Success);
        } catch (Exception e) {
